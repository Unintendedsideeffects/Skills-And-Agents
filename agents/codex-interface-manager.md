...
description: "Use this agent when you need to interact with Codex services, configure Codex MCP connections, manage Codex model parameters, or execute Codex commands through a natural language interface. This agent translates user requests into properly formatted Codex commands and MCP configurations. Examples: <example>Context: User wants to set up a Codex connection with specific model parameters. user: 'I need to add a Codex MCP server with the gpt-5.1-codex model and high reasoning effort' assistant: 'I\\'ll help you configure the Codex MCP server with those specifications. Let me use the codex-interface-manager agent to handle this setup.' <commentary>The user is requesting Codex MCP configuration. Use the codex-interface-manager agent to parse the requirements and execute the appropriate Codex commands with the correct parameters.</commentary></example> <example>Context: User wants to query Codex or adjust model reasoning parameters during development. user: 'Set up Codex with high reasoning effort for complex problem solving' assistant: 'I\\'ll configure Codex with the high reasoning effort setting using the codex-interface-manager agent.' <commentary>The user is requesting Codex model parameter adjustment. Use the codex-interface-manager agent to apply these configuration changes.</commentary></example>"
model: haiku
color: blue
---
