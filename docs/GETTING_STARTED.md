...
```bash
cd /path/to/Skills-And-Agents/agent-manager
uv sync
```
...
1. **Read the docs**: `docs/AGENT_MANAGER.md` for complete reference
...
- **For questions about Agent Manager**: See `docs/AGENT_MANAGER.md`
